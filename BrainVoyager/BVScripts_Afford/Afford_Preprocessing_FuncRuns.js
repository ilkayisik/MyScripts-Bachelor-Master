...
var MainDataPath = "D:/TEST/P02/Topup/FunctionalRuns";  //Change for each Subject
var NumberOfRuns = 5;
var SubjectRunPrefix = "P02_Run" //Change for each Subject

// Enter fmr file paths //Change for each Subject
var InFmrList = ["D:/TEST/P02/Topup/FunctionalRuns/P02_Run1.fmr", 
"D:/TEST/P02/Topup/FunctionalRuns/P02_Run2.fmr",
"D:/TEST/P02/Topup/FunctionalRuns/P02_Run3.fmr",
"D:/TEST/P02/Topup/FunctionalRuns/P02_Run4.fmr",
"D:/TEST/P02/Topup/FunctionalRuns/P02_Run5.fmr"]

//----------------------------------------------------------------
for(count = 1; count <= NumberOfRuns; count++){
    
    var RunPath = MainDataPath
    var RunName = SubjectRunPrefix + String(count) + "_PP"; //<------ //Change for each Subject
    ...
    docFMR.CorrectSliceTiming(10, 1); // Scan order 10:Descending; Interpolation method 0: trilinear, 1: cubic spline, 2: windowed sinc
 ...
 // High-pass filtering
    docFMR.TemporalHighPassFilterGLMFourier(2); 2 
    ResultFileName = docFMR.FileNameOfPreprocessdFMR;
    docFMR.Close();
