 ...
 */
public class Spatial2AFC extends FullScreen implements Runnable{
  ...
  static final double[] INITIAL_ORIENTATION = {
  	 1.5*ONE_DEGREE, -1.5*ONE_DEGREE, 0.1*ONE_DEGREE, -0.1*ONE_DEGREE};
  ...
  public static void main(String[] args){
	  ...
	  Spatial2AFC aod = new Spatial2AFC();
  ...
  public void run() {
    ...
    try{
      ...
      displayText(100, 300, "Indicate the side of the screen");
      displayText(100, 350, "with the left-oblique Gabor");    
      displayText(100, 400, "using Left/Right arrow keys");
      ...
      for(int trial=0; trial<N_TRIALS; trial++){
      	...
      	while(staircaseIDIt.hasNext()){
      		...
      		outputFile.printf("%d %3.5f ", stID, stimLevel*180/PI);

      		BufferedImage gbr1 = Extras.gabor(MEAN, CPP, CONTRAST, PHASE, SIGMA, stimLevel);
      		BufferedImage gbr2 = Extras.gabor(MEAN, CPP, CONTRAST, PHASE, SIGMA, -stimLevel);
