...
public class MTS2AFCNEW extends FullScreen implements Runnable {
  ...
  static final long ISI = 500l;
 
  
  public static void main(String[] args){
    
	  MTS2AFCNEW aod = new MTS2AFCNEW();
  ...
  public void run() {
    ...
    } catch (PixelOutOfRangeException e1) {
      e1.printStackTrace();
