 ...
 *
 */
public class Wedges_OL_CW_Fixation extends FullScreen implements Runnable {
  ...
  static final int ANGLE_FIRST_WEDGE = -180;
  ...
  public static void main(String[] args){
    ...
    Wedges_OL_CW_Fixation loc = new Wedges_OL_CW_Fixation();
    loc.setNBuffers(2);
