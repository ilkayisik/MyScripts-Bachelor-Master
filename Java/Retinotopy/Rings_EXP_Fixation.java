...
/**
 * Block design. Expanding flickering rings with non-overlapping jumps 
 * 
 * @author boyaci
 * @version 2011-05-04
 *
 */
public class Rings_EXP_Fixation extends FullScreen implements Runnable {
  ...
  public static void main(String[] args){
    ...
    Rings_EXP_Fixation loc = new Rings_EXP_Fixation();
    loc.setNBuffers(2);
  ...
  public BufferedImage makeCheckerRing(int dim, int Nradsegment,
    ...
    for(double r = rout; r>rin; r -= 2*rIncr){
      ...
      for(int t = 0; t<360; t+= tIncr){
        ...
        g.setColor(colring[1]);
        g.fillArc((int)(rout-r)/2, (int)(rout-r)/2, (int)(ceil(r)),(int)(ceil(r)),
t, tIncr);
        ...
        if (rp<=rin)
          break;
        g.fillArc((int)(rout-rp)/2, (int)(rout-rp)/2,
(int)(ceil(rp)),(int)(ceil(rp)), t, tIncr);
