...
array <int> orders[122] = {8,0,6,2,0,4,1,4,0,7,0,7,8,0,7,7,0,1,0,3,1,1,2,0,3,7,4,0,1,6,0,6,6,0,5,0,4,0,4,5,5,0,5,0,2,1,0,8,6,3,6,0,2,5,3,0,7,0,3,0,4,6,3,0,1,5,1,0,2,0,2,6,0,1,8,4,7,0,1,8,0,8,8,5,0,8,0,6,0,5,0,7,3,0,2,2,0,8,0,2,0,7,4,0,4,0,3,0,3,0,2,8,0,7,5,0,5,4,3,0,6,0};
array <int> durations[122] = {5000,5000,5000,5000,5000,5000,5000,5000,5000,5000,7500,5000,5000,7500,5000,5000,5000,5000,2500,5000,5000,5000,5000,5000,5000,5000,5000,2500,5000,5000,5000,5000,5000,5000,5000,12500,5000,2500,5000,5000,5000,12500,5000,2500,5000,5000,2500,5000,5000,5000,5000,5000,5000,5000,5000,5000,5000,2500,5000,5000,5000,5000,5000,7500,5000,5000,5000,2500,5000,2500,5000,5000,7500,5000,5000,5000,5000,2500,5000,5000,2500,5000,5000,5000,5000,5000,2500,5000,2500,5000,2500,5000,5000,2500,5000,5000,5000,5000,2500,5000,7500,5000,5000,5000,5000,5000,5000,2500,5000,12500,5000,5000,2500,5000,5000,2500,5000,5000,5000,5000,5000,5000};
...
###########################                                
output_file orders_Run2 = new output_file;
orders_Run2.open( "orders_Run2.txt" ); 
...
###########################
output_file durations_Run2 = new output_file;
durations_Run2.open( "durations_Run2.txt" ); 
...
until
	i > 122
begin
	durations_Run2.print(durations[i]);
	durations_Run2.print( "\n" );  
	i = i + 1
end;
durations_Run2.close();
###########################

###########################
output_file ii_Run2 = new output_file;
ii_Run2.open( "ii_Run2.txt" ); 
...
until
	i > 10
begin
	ii_Run2.print(ii[1][i]);
	ii_Run2.print( "\t" );  
	ii_Run2.print(ii[2][i]);
	ii_Run2.print( "\t" );  
	ii_Run2.print(ii[3][i]);
	ii_Run2.print( "\t" );  
	ii_Run2.print(ii[4][i]);
	ii_Run2.print( "\t" );  
	ii_Run2.print(ii[5][i]);
	ii_Run2.print( "\t" );  
	ii_Run2.print(ii[6][i]);
	ii_Run2.print( "\t" );  
	ii_Run2.print(ii[7][i]);
	ii_Run2.print( "\t" );  
	ii_Run2.print(ii[8][i]);
	ii_Run2.print( "\n" );
	i = i + 1
end;
ii_Run2.close();
...
###########################
output_file pp_Run2 = new output_file;
pp_Run2.open( "pp_Run2.txt" ); 
...
###########################
output_file lll_Run2 = new output_file;
lll_Run2.open( "lll_Run2.txt" ); 
...
output_file exp_Run2 = new output_file;
exp_Run2.open( "exp_Run2.txt" ); 
