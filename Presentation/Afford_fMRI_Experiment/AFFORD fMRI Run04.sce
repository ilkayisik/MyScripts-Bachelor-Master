...
array <int> orders[122] = {7,1,0,3,2,0,3,1,1,0,8,5,0,4,3,4,2,0,2,4,0,6,0,5,0,2,3,0,5,0,2,8,0,2,0,5,0,6,0,7,7,0,3,0,7,2,4,0,4,0,2,0,6,7,0,6,0,3,0,2,0,4,0,8,8,0,1,5,0,5,1,0,1,3,5,6,1,4,7,0,7,4,6,7,0,8,4,7,5,0,8,0,6,0,5,0,8,6,0,4,5,8,0,1,0,7,0,6,1,6,3,0,2,0,3,0,8,3,0,8,1,0};
array <int> durations[122] = {5000,5000,7500,5000,5000,5000,5000,5000,5000,2500,5000,5000,5000,5000,5000,5000,5000,7500,5000,5000,2500,5000,5000,5000,5000,5000,5000,5000,5000,7500,5000,5000,7500,5000,5000,5000,2500,5000,5000,5000,5000,2500,5000,10000,5000,5000,5000,7500,5000,2500,5000,5000,5000,5000,10000,5000,5000,5000,5000,5000,5000,5000,2500,5000,5000,2500,5000,5000,2500,5000,5000,10000,5000,5000,5000,5000,5000,5000,5000,7500,5000,5000,5000,5000,2500,5000,5000,5000,5000,5000,5000,2500,5000,2500,5000,2500,5000,5000,2500,5000,5000,5000,2500,5000,2500,5000,7500,5000,5000,5000,5000,2500,5000,7500,5000,2500,5000,5000,2500,5000,5000,5000};
...
###########################                                
output_file orders_Run4 = new output_file;
orders_Run4.open( "orders_Run4.txt" ); 
...
###########################
output_file durations_Run4 = new output_file;
durations_Run4.open( "durations_Run4.txt" ); 
...
until
	i > 122
begin
	durations_Run4.print(durations[i]);
	durations_Run4.print( "\n" );  
	i = i + 1
end;
durations_Run4.close();
###########################

###########################
output_file ii_Run4 = new output_file;
ii_Run4.open( "ii_Run4.txt" ); 
...
until
	i > 10
begin
	ii_Run4.print(ii[1][i]);
	ii_Run4.print( "\t" );  
	ii_Run4.print(ii[2][i]);
	ii_Run4.print( "\t" );  
	ii_Run4.print(ii[3][i]);
	ii_Run4.print( "\t" );  
	ii_Run4.print(ii[4][i]);
	ii_Run4.print( "\t" );  
	ii_Run4.print(ii[5][i]);
	ii_Run4.print( "\t" );  
	ii_Run4.print(ii[6][i]);
	ii_Run4.print( "\t" );  
	ii_Run4.print(ii[7][i]);
	ii_Run4.print( "\t" );  
	ii_Run4.print(ii[8][i]);
	ii_Run4.print( "\n" );
	i = i + 1
end;
ii_Run4.close();
...
###########################
output_file pp_Run4 = new output_file;
pp_Run4.open( "pp_Run4.txt" ); 
...
###########################
output_file lll_Run4 = new output_file;
lll_Run4.open( "lll_Run4.txt" ); 
...
output_file exp_Run4 = new output_file;
exp_Run4.open( "exp_Run4.txt" ); 
